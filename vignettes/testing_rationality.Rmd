...
ggsave(here::here("graphs","empirical_cceis.pdf"), width=16, height = 10, units = "cm", device=cairo_pdf)
ggsave(here::here("graphs","empirical_cceis.eps"), width=16, height = 10, units = "cm", device=cairo_ps)
```
...
ggsave(here::here("graphs", "empirical_cceis_and_Bronars.pdf"), width=16, height = 10, units="cm", device=cairo_pdf)
ggsave(here::here("graphs", "empirical_cceis_and_Bronars.eps"), width=16, height = 10, units="cm", device=cairo_ps)
```
