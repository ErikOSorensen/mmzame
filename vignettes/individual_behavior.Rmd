...
ggsave(here::here("graphs", "logprice_scatters.pdf"), width=20, height = 14, units = "cm", device=cairo_pdf)
embed_fonts(here::here("graphs", "logprice_scatters.pdf"))
ggsave(here::here("graphs", "logprice_scatters.eps"), width=20, height = 14, units = "cm", device=cairo_ps)
```
