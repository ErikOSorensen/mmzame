...
for (x in p3_00) {
  ...
  embed_fonts(here::here("graphs", "prop3_tests",fname))
}
```
...
for (x in p4_00) {
  ...
  ggsave(here("graphs", "prop4_tests", fname), 
         plot = g, width=7.29, height = 4.5, units="in")
  embed_fonts(here::here("graphs","prop4_tests", fname))
}
```
...
ggsave(here("graphs", "test_of_propositions.pdf"), plot=propositions, 
       width=7.29, height = 4.5, units="in")
embed_fonts(here::here("graphs","test_of_propositions.pdf"))
```


## Now for a table variant
For the table, we don't distinguish between the two propositions.
...
ggsave(here("graphs", "power_analysis.pdf"), width=7.29, height=4.5, units="in")
embed_fonts(here::here("graphs", "power_analysis.pdf"))
```

## Now for a Table variant
We want a table variant (for now, only proposition 3):
```{r}
