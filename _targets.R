...
list(
  ...
  tar_target(mmzame_decisions_mirror, create_mirrored_decisions(mmzame_decisions)),
  ...
  tar_target(prop3listm, prepare_decisions(mmzame_decisions_mirror, c("moral","risk"))),
  ...
  tar_target(p2_00m, purrr::map(prop2listm, p_permutations_bronars, np=NP_S, p_Bronars=0.00, rFOSD=TRUE)),
  tar_target(p3_00m, purrr::map(prop3listm, p_permutations_bronars, np=NP_S, p_Bronars=0.00, rFOSD=TRUE)),
  ...
  tar_target(p4_00m, purrr::map(prop4listm, p_permutations_bronars, np=NP_S, p_Bronars=0.00, rFOSD=TRUE)),
  ...
  tar_target(background, background_table(mmzame_background)),
  ...
  tar_render(Appendix, here::here("vignettes","Appendix.Rmd")),
